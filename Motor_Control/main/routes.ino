...
void erase_route(struct route_t* route)
{
...
void upload_route(struct route_t* route)
{
  ...
  EEPROM.write(route->index, route->size);
  erase_route(route);
